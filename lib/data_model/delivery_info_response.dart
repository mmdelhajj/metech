...
List<DeliveryInfoResponse> deliveryInfoResponseFromJson(String str) {
  ...
  if (data is List) {
    return List<DeliveryInfoResponse>.from(
      data.map((x) => DeliveryInfoResponse.fromJson(x)),
    );
  } else if (data is Map && data["data"] != null) {
    return List<DeliveryInfoResponse>.from(
      data["data"].map((x) => DeliveryInfoResponse.fromJson(x)),
    );
  } else {
    return [];
  }
...
class DeliveryInfoResponse {
  ...
  factory DeliveryInfoResponse.fromJson(Map<String, dynamic> json) =>
      DeliveryInfoResponse(
        ...
        pickupPoints: json["pickup_points"] != null
